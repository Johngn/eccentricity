...
tau_e_inverse_CN = 0.78*(1-0.14*ehat**2+0.06*ehat**3)**(-1)                                      # equation 17 from Ida 2020
tau_m_inverse_CN = (2.7+1.1*0.5)/(2)*h**2*(1-(ehat/2.02)**4)/(1+(ehat/2.25)**0.5+(ehat/2.84)**6) # equation 18 from Ida 2020
tau_a_inverse_CN = 2*tau_m_inverse_CN+2*e**2*tau_e_inverse_CN                                                    # equation 16 from Ida 2020
...
tau_e_inverse_IDA = 0.780*(1+(1/15)*ehat**3)**(-1)                   # equation 34 from Ida 2020
tau_a_inverse_IDA_red = Ct_red*h**2*(1+(Ct_red/Cm_red)*ehat)**(-1)   # equation 38 from Ida 2020
tau_m_inverse_IDA_red = 0.5*tau_a_inverse_IDA_red - e**2*tau_e_inverse_IDA           # equation 39 from Ida 2020
# magenta lines in plot
tau_a_inverse_IDA_mag = Ct_mag*h**2*(1+(Ct_mag/Cm_mag)*ehat)**(-1)   # equation 38 from Ida 2020
tau_m_inverse_IDA_mag = 0.5*tau_a_inverse_IDA_mag - e**2*tau_e_inverse_IDA           # equation 39 from Ida 2020
...
ax[0].plot(ehat, tau_e_inverse_CN, label='CN08', c='blue')
ax[0].plot(ehat, tau_e_inverse_IDA, label='IDA20', c='red')
ax[0].set_xscale('log')
ax[0].set_yscale('log')
...
ax[1].plot(ehat, tau_m_inverse_CN, label='CN08', c='blue')
ax[1].plot(ehat, -tau_m_inverse_CN, c='blue', ls='--')
ax[1].plot(ehat, tau_m_inverse_IDA_red, label='IDA20 p=1 q=0.5', c='red')
ax[1].plot(ehat, -tau_m_inverse_IDA_red, c='red', ls='--')
ax[1].plot(ehat, tau_m_inverse_IDA_mag, label='IDA20 p=0.5 q=1', c='magenta')
ax[1].plot(ehat, -tau_m_inverse_IDA_mag, c='magenta', ls='--')
ax[1].set_xscale('log')
ax[1].set_yscale('log')
...
ax[2].plot(ehat, tau_a_inverse_CN, label='CN08', c='blue')
ax[2].plot(ehat, tau_a_inverse_IDA_red, label='IDA20 p=1 q=0.5', c='red')
ax[2].plot(ehat, tau_a_inverse_IDA_mag, label='IDA20 p=0.5 q=1', c='magenta')
ax[2].set_xscale('log')
ax[2].set_yscale('log')
ax[2].set_xlabel('e/h')
